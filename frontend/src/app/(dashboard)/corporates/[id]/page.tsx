...
function rowCalc(t: SoldTicket, additionalStr: string, discountStr: string, billingType: Corporate["billing_type"]) {
...
export default function CorporateDetailPage() {
  ...
  const applyRange = useCallback(async () => {
    ...
    try {
      const { data } = await api.get<SoldTicketsResponse>(`/corporates/${corporateId}/sold-tickets`, {
      ...
      {loadingCorporate ? (
        ...
        <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-6">
          <div className="grid grid-cols-2 md:grid-cols-3 gap-5">
            ...
            <DetailRow label="Markup Type" value={corporate.markup_type ? corporate.markup_type.charAt(0).toUpperCase() + corporate.markup_type.slice(1) : "—"} />
              ...
              <div className="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
                <div className="px-4 py-3 border-b border-gray-100">
                  ...
                  <p className="text-[10px] text-gray-400 mt-0.5">
                    ...
                    {corporate.markup_type ? ` (${corporate.markup_type})` : ""} · Billing:{" "}
                        ...
                        <tr>
                          <td colSpan={26} className="px-4 py-16 text-center">
                            <div className="flex flex-col items-center justify-center">
                              ...
                              <p className="text-xs text-gray-400 mt-1">No tickets matched this corporate&apos;s name between {dateFrom} and {dateTo}.</p>
                            </div>
                          </td>
                        </tr>
                      ) : (
