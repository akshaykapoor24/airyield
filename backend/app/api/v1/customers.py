...
async def create_billing(
    ...
    for t in tickets:
        ...
        # The CUSTOMER'S AGREED MARKUP alone is taxed — see api/v1/corporates.py for
        # why the additional markup is not part of the tax base.
        taxable = gst_taxable(base, cust_markup, customer.billing_type, disc)
        split = _split_gst(base, cust_markup, customer.billing_type, disc, interstate=pos.interstate)
