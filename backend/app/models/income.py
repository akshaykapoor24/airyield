...
from sqlalchemy import DateTime, ForeignKey, Numeric, Boolean, Text, String, Integer
...
class IncomeRecord(Base):
    ...
    # legacy_deals table has been removed; kept as a plain int (no FK). Legacy/unused.
